...
task usercontrol()
{
	...
	while(1)
	{
		...
		{
				motor[TLeft] =  vexRT[Btn5UXmtr2]*60;
				motor[BLeft] =  vexRT[Btn5UXmtr2]*60;
				motor[TRight] =  vexRT[Btn6UXmtr2]*60;
				motor[BRight] =  vexRT[Btn6UXmtr2]*60;
		}
		else if((vexRT[Btn5DXmtr2]||vexRT[Btn6DXmtr2])&&abs(vexRT[Ch2Xmtr2])<thresh)
		{
				motor[TLeft] =  vexRT[Btn5DXmtr2]*-60;
				motor[BLeft] =  vexRT[Btn5DXmtr2]*-60;
				motor[TRight] =  vexRT[Btn6DXmtr2]*-60;
				motor[BRight] =  vexRT[Btn6DXmtr2]*-60;
		}
