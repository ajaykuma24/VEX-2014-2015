...
#pragma config(Motor,  port2,           rearRightMotor, tmotorVex393, PIDControl, reversed, encoder, encoderPort, I2C_2, 1000)
#pragma config(Motor,  port3,           frontRightMotor, tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port4,           rearLeftMotor, tmotorVex393, PIDControl, encoder, encoderPort, I2C_1, 1000)
#pragma config(Motor,  port5,           frontLeftMotor, tmotorVex393, openLoop)
#pragma config(Motor,  port6,           ArmRight,      tmotorVex393, PIDControl, reversed, encoder, encoderPort, I2C_3, 1000)
#pragma config(Motor,  port7,           ArmLeft,       tmotorVex393, PIDControl, encoder, encoderPort, I2C_4, 1000)
...
//G_encodercounts=5000;
G_speed=80;
G_time=2250;
StartTask(upperArmLift);
wait1Msec(2250);
StartTask(upperArmLower);
wait1Msec(2250);
G_speed=80;
G_time=875;
StartTask(upperArmLift);
...
StartTask(upperArmLower);
wait1Msec(750);
StartTask(bottomArmLower);
moveBackward(100, 111);
*/
...
/*
G_timecurrent = nSysTime;
StartTask(upperArmLimit);
while(G_taskend == 0)
{
}
G_timemeasure = nSysTime - G_timecurrent;
wait1Msec(5000);
...
G_encodercounts=5000;
G_speed=80;
StartTask(bottomArmLift);
wait1Msec(750);
StopTask(bottomArmLift);
